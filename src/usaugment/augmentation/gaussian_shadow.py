"""An implementation of the Gaussian shadow transform described in "Highlighting nerves and blood vessels for
ultrasound-guided axillary nerve block procedures using neural networks" (Smistad et al., 2018).
"""
...
if __name__ == "__main__":
    ...
    augmentation = GaussianShadow(strength=0.8, sigma_x=0.05, sigma_y=0.05, p=1.0)

    augmented_image = augmentation.apply(img=image)
    attenuation_map = augmentation._generate_shadow_image(*image.shape[:2])
