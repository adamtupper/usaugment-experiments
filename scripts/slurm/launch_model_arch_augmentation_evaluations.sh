...
# sbatch --time=24:00:00 --job-name=camus_classification usaugment-experiments/scripts/slurm/train.sh camus_v4 camus_classification mitb2_multiclass
# sbatch --time=24:00:00 --job-name=camus_classification usaugment-experiments/scripts/slurm/train.sh camus_v4 camus_classification efficientnetb5_multiclass
# sbatch --time=82:00:00 --job-name=camus_segmentation usaugment-experiments/scripts/slurm/train.sh camus_v4 camus_segmentation segformerb2_multiclass
# sbatch --time=82:00:00 --job-name=camus_segmentation usaugment-experiments/scripts/slurm/train.sh camus_v4 camus_segmentation efficientnetb5_unet_multiclass
