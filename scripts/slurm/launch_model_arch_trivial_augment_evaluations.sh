...
# sbatch --time=48:00:00 --job-name=camus_segmentation usaugment-experiments/scripts/slurm/train_trivial_augment.sh camus_v4 camus_segmentation segformerb2_multiclass 0.0000464159 0.00001
sbatch --time=48:00:00 --job-name=camus_segmentation usaugment-experiments/scripts/slurm/train_trivial_augment.sh camus_v4 camus_segmentation efficientnetb5_unet_multiclass 0.000215443 0.0000316228
